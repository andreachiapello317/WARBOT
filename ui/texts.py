...
def help_text() -> str:
    return (
        ...
        "✈️ <b>AIR TRAFFIC</b> — aerei LIVE sulla stessa località (ADSB.lol, non Overpass)\n\n"
        "La città si geocodifica una volta. Passare da OSM ad AIR TRAFFIC non rifà il geocoding.\n"
        "Il menu mondi non chiama né Overpass né ADSB.lol.\n\n"
        "/osm — apre OSM se la città c'è già\n"
        "/airtraffic — apre AIR TRAFFIC se la città c'è già\n"
        "/aiuto — questo elenco\n\n"
